...
#[derive(Debug)]
pub struct UnityWorksProcessor {
    verbose: bool,
    processed_count: usize,
}

impl UnityWorksProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting UnityWorks processing");
    
    let mut processor = UnityWorksProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = UnityWorksProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = UnityWorksProcessor::new(false);
